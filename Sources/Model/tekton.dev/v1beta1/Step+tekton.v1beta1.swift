...
public extension tekton.v1beta1 {
    struct Step: KubernetesResource {
        // MARK: Lifecycle
...
public extension tekton.v1beta1.Step {
    ...
    init(from decoder: Decoder) throws {
        ...
        timeout = try container.decodeIfPresent(Int32.self, forKey: .timeout)
        workspaces = try container.decodeIfPresent([tekton.v1beta1.WorkspaceUsage].self, forKey: .workspaces)
        onError = try container.decodeIfPresent(String.self, forKey: .onError)
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try encodingContainer.encode(timeout, forKey: .timeout)
        try encodingContainer.encode(workspaces, forKey: .workspaces)
        try encodingContainer.encode(onError, forKey: .onError)
    }
}
